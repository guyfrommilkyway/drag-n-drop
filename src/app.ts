...
class ProjectState extends State<Project> {
  ...
  private updateListeners() {
    for (const listerneFn of this.listeners) {
      listerneFn(this.projects.slice());
    }
  }
}
...
abstract class Component<T extends HTMLElement, U extends HTMLElement> {
  ...
  private attach(insertType: boolean) {
    this.hostElement.insertAdjacentElement(insertType ? 'afterbegin' : 'beforeend', this.element);
  }
